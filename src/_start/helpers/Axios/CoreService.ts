...
import { CORE_ExecProcedureByTipoConsulta,  CORE_getconsultadinamicas, CORE_getconsultadinamicasUser, CORE_GetConsultasDinamicas, CORE_getGruposSeguridad, CORE_setGrupoSeguridad } from "../../../apiurlstore";
