...
export const ExportarExcel: React.FC<Props> = () => {
    ...
    const exportarExcel = async () => {
        ...
        console.log(moment(fechaInicial).format(FormatoSerializacionYYYY_MM_DD_HHmmss));
        console.log(moment(fechaFinal).endOf('day').format(FormatoSerializacionYYYY_MM_DD_HHmmss));
