...
const Churn: React.FC<Props> = ({ SetShow, Show }) => {
  const { DataAcumulado, showChurn, setshowChurn } = useDataDashboard();
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-xl-12 col-md-12 col-lg-12 pt-12">
              ...
              <div className="d-flex justify-content-between mb-2">
                <div className="mx-auto">
                  <div className="ms-3 text-center">
                    <h3 className="mb-0">Churn</h3>
                    <span className="text-muted m-3">{`Consolidado ${SemanaAnterior} y ${SemanaActual}`}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container w-100" style={{display: (churnDataEntradas.length != 0 ? "inline":"none")}}>
              <div className="row">
