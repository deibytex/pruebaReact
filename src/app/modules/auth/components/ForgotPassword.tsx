      ...
      >
        <div className="pb-5 pb-lg-10">
          ...
          <p className="text-muted fw-bold fs-3">
            Ingrese su correo electrónico para crear una nueva contraseña
          </p>
        </div>
        ...
        {hasErrors === true && (
          <div className="mb-lg-15 alert alert-danger">
            <div className="alert-text font-weight-bold">
              Hubo un error al recuperar la contraseña, favor contactese con su administrador.
            </div>
          </div>
        )}
        ...
        {hasErrors === false && (
          <div className="mb-lg-15 alert alert-info">
            <div className="alert-text ">
             Un correo se ha enviado, favor verifique.
            </div>
          </div>
        )}
        {/* end::Title */}
